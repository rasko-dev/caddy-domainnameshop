...
- Rolling tags are only updated when their embedded `io.github.rasko-dev.caddy-version` label is older than (or missing compared to) the version being built.
